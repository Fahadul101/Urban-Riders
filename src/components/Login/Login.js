    ...
    return (
        <div>
            ...
            <div className="container">
                <h3 className="text-center">______________________Or___________________</h3>
                <button onClick={handleGoogleSignIn} className="btn-info p-3 m-left mb-3">Continue with Google</button><br />
                <button onClick={handleFacebookSignIn} className="btn-info p-3 m-left">Continue with Facebook</button>
            </div>
        </div>
    );
};
